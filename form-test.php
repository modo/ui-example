	...
	<div id="body-container">
		...
		<?php include( 'lib/inc/header.php' ); ?>
			...
			<div id="content" class="row">
				...
				<div class="span10">
					<aside id="highlighted" class="hero-unit">
						<h1>Banner area</h1>
					</aside>
			            	...
			            	<form class="form-horizontal">
			            		<fieldset>
			            			...
			            			<div class="control-group">
			            				...
			            				<div class="controls">
			            					<label class="checkbox"><input type="checkbox" id="optionsCheckbox" value="option1">Option one is this and that—be sure to include why it's great</label>
			            				</div>
			            			</div>
			            			<div class="control-group">
			            				...
			            				<div class="controls">
			            					<select id="select01" name="select01">
			            						<option value="sm">something really really long</option>
			            						<option>2</option>
			            						<option>3</option>
			            						<option>4</option>
			            						<option>5</option>
